...
UPDATE `tbl_email_cms` SET `sectionDescription` = '<p>Dear szName, <br /> <br /> <br /> <br /> <br /> Welcome to Drug-Safe Communities!<br /> <br/> <br/> <br/> Please click on the link to login in to Drug-Safe Communities : <br/><br/> Link<br/><br/> You can login on Drug-Safe Communities Mobile Application with the following login details.<br/> <br/> Email - szEmail <br/> Password - szPassword <br/> <br /> Kind regards,<br /> Drug-Safe Communities.</p>' WHERE `tbl_email_cms`.`id` = 6;
UPDATE `tbl_email_cms` SET `sectionDescription` = '<p>Dear szName, <br /> <br /> <br /> <br /> <br /> Welcome to Drug-Safe Communities !<br /> <br/> <br/> <br/> Please click on the link to login in to Drug-Safe Communities : <br/><br/> Link <br/><br/> You can login on Drug-Safe Communities Mobile Application with the following login details.<br/> <br/> Email - szEmail <br/> Password - szPassword <br/> <br /> Kind regards,<br /> Drug-Safe Communities.</p>' WHERE `tbl_email_cms`.`id` = 3;