            ...
            <div id="page_content" class="row">
                ...
                <div class="col-md-12">
                     <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <span class="active">Edit Consumables</span>
                        </li>
                    </ul>
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="icon-equalizer font-red-sunglo"></i>
                                    <span class="caption-subject font-red-sunglo bold uppercase">edit Consumables</span>
                            </div>
                            <div class="actions">
                        ...
                        <div class="portlet-body">
                            <form class="form-horizontal" id="clientData" action="<?php echo __BASE_URL__?>/inventory/editConsumables" name="productDate" method="post">
                                <div class="form-body">
