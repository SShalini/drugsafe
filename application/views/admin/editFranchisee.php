<div class="page-content-wrapper">
 ...
 <div
                                ...
                                <div class="stateReginol <?php echo $stateReginolClass;?>">
                                    <div
                                ...
                                ?>
                                    ...
                                    <input id="reginolId" class="form-control" type="hidden" value="<?php echo $reginolId;?>"  name="addFranchisee[reginolid]">
