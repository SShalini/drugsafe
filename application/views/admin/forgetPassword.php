...
/*                    }
            ...
            ?>
                ...
                <div class="form-group">
                    <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Email" name="drugSafeForgotPassword[szEmail]" onfocus="remove_formError(this.id,'true')"  value="<?php echo $_POST['drugSafeForgotPassword']['szEmail'];?>" >
