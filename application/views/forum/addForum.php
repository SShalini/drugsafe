                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-red-sunglo bold uppercase">Add Forum</span>
                            </div>
                            <div class="actions">
                        ...
                        <div class="portlet-body">
                            <form class="form-horizontal" id="forumData" action="<?php echo __BASE_URL__?>/forum/addforum" name="forumData" method="post">
                                <div class="form-body">
							...
							<?php
                                            ...
                                            <p id="upload_error_status" class="hide" style="font-color:#e73d4a">Error occur while uploading image. Please inform to DrugSafe.</p>
                                        </div>
                                             <?php
