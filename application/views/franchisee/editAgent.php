        ...
        <div id="page_content" class="row">
            <div class="col-md-12">
                <ul class="page-breadcrumb breadcrumb">
                  ...
                  <?php  $userDataAry = $this->Admin_Model->getUserDetailsByEmailOrId('',$idAgent);
                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body">
                        <form class="form-horizontal" id="clientData"
                              action="<?php echo __BASE_URL__ ?>/franchisee/editAgentEmployee" name="clientData" method="post">
