...
/*array_push($ProformaInvoiceRecords,$dataArr);
							...
							array_multisort($InvoiceDateArr, SORT_DESC, $dataArr);
							if(!empty($dataArr)){
                                    ...
                                    <tr>
                                        ...
                                        <td>
										    ...
										    if ( $records['emptydata'] == '1' ) {
											    ...
											    if ( $recordsArr['editrec'] == '1' ) {
												    ?>
                                                    <a class="btn btn-circle btn-icon-only btn-default"
                                                       id="editCalcForm" title="Edit Calc Form"
                                                       onclick="editCalcForm(<?php echo $records['actionClientid']; ?>,<?php echo $records['actionarr']; ?>,<?php echo $records['actionsosdata']; ?>,<?php echo $records['id']; ?>);"
                                                       href="javascript:void(0);"></i>
