    ...
    <!--CUSTOM JS-->
       ...
       <script src="<?php echo __BASE_JS_URL__;?>/drugsafeFunctions.js?<?php echo time(); ?>" rel="jquery" type="text/javascript"></script>
        ...
        <script src="<?php echo __BASE_ASSETS_URL__; ?>/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
        <script src="<?php echo __BASE_ASSETS_URL__; ?>/global/plugins/jquery-validation/js/additional-methods.min.js" type="text/javascript"></script>
        <script src="<?php echo __BASE_ASSETS_URL__; ?>/global/plugins/select2/js/select2.full.min.js" type="text/javascript"></script>
        ...
        <script src="<?php echo __BASE_ASSETS_URL__; ?>/pages/scripts/login.min.js" type="text/javascript"></script>
