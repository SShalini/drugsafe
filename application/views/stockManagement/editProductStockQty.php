                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject  bold uppercase font-red-sunglo">Edit Product Stock Quantity</span>
                        </div>
                        <div class="tools">
                    ...
                    <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                        <form action=""  id="editProductStockQty" name="editProductStockQty" method="post" class="form-horizontal form-row-sepe">
                            <div class="form-body">
                                ...
                                <div class="form-group <?php if(form_error('editProductStockQty[szProductCode]')){?>has-error<?php }?>">
                                    <label class="control-label col-md-3">Product</label>
                                        <div class="col-md-4">
                                           ...
                                           <?php
                                            ...
                                            <span class="help-block pull-left"><span><?php echo form_error('editProductStockQty[szProductCode]');?></span>
                                            </span><?php }?>   
                                        </div>
                                </div>
                                <?php 
                                ...
                                <div class="form-group <?php if(form_error('editProductStockQty[szAddMoreQuantity]')){?>has-error<?php }?>">
                                    <label class="control-label col-md-3">Add More Quantity</label>
                                        <div class="col-md-4">
                                          ...
                                          <?php
                                            ...
                                            <span class="help-block pull-left"><span><?php echo form_error('editProductStockQty[szAddMoreQuantity]');?></span>
                                            </span><?php }?> 
                                        </div>
                                </div>  
                                  <?php }
                            ...
                            <div class="row">
                                <div class="col-md-offset-3 col-md-4">
                                    ...
                                    <input type="submit" class="btn green-meadow" value="Save" name="editProductStockQty[submit]">
                                </div>
                            </div>
